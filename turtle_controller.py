...
def msg_callback(msg: Pose):
    ...
    if msg.x >=5.5 and previous_x < 5.5:
        ...
        call_set_pen_service(200,0,0,3,0)
...
if __name__=='__main__':
    ...
    call_set_pen_service(200,10,0, 3, 0)
    sub = rospy.Subscriber("/turtle1/pose",Pose,callback= msg_callback)
